...
exports.generateJSKeys = exports.generateSessionKeys10 = exports.generateSessionKeys11 = exports.generateSessionKeys = exports.decryptJoinAccept = exports.decryptFOpts = exports.decryptJoin = exports.decrypt = exports.encrypt = void 0;
...
function generateJSKeys(NwkKey, DevEui) {
    if (DevEui.length !== 8)
        throw new Error("Expected a DevEui with length 16");
    if (NwkKey.length !== 16)
        throw new Error("Expected a NwkKey with length 16");
    return {
