...
var _InputOutputController_instances, _InputOutputController_optionalInputs, _InputOutputController_preOnInput, _InputOutputController_inputErrorHandler;
...
_InputOutputController_optionalInputs = new WeakMap(), _InputOutputController_instances = new WeakSet(), _InputOutputController_preOnInput = async function _InputOutputController_preOnInput(message, send, done) {
        ...
        for (const [, { schema, handler }] of __classPrivateFieldGet(this, _InputOutputController_optionalInputs, "f")) {
            ...
            if (validSchema) {
                try {
                    ...
                    __classPrivateFieldGet(this, _InputOutputController_instances, "m", _InputOutputController_inputErrorHandler).call(this, error, done);
                }
            }
        }
    }
    ...
    try {
        ...
        __classPrivateFieldGet(this, _InputOutputController_instances, "m", _InputOutputController_inputErrorHandler).call(this, e, done);
    }
}, _InputOutputController_inputErrorHandler = function _InputOutputController_inputErrorHandler(e, done) {
    ...
    if (e instanceof joi_1.default.ValidationError) {
        ...
        done === null || done === void 0 ? void 0 : done(e);
    }
        ...
        done === null || done === void 0 ? void 0 : done(new Error(e));
    }
    else {
        done === null || done === void 0 ? void 0 : done(new Error(`Unrecognised error: ${e}`));
    }
